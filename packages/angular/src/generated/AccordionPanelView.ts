...
@Component({
  selector: "accordion-panel-view",
  standalone: true,
  imports: [CommonModule],
  template: `<div #elRef0 #_root><ng-content></ng-content></div> `,
  changeDetection: ChangeDetectionStrategy.OnPush,
  styles: `:host { display: contents; }`,
})
export class AccordionPanelView implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    if (typeof window !== "undefined") {
      ...
      this.enableAttributePassing(element, "accordion-panel-view");
      this.setAttributes(this.elRef0()?.nativeElement, this.attributes());
    }
  }
